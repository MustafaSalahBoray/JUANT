    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="Advertisments.php"></a> Advertisments</li>
          <li class="breadcrumb-item active">pricing Advertisment plans</li>
              ...
              <div class="card">
                <div class="card-body pt-3">
                  <div class="back-bar text-center">
                    <a href="Advertisments.php"><i class="bi bi-x-circle-fill"></i>                   
                    </a>
                  </div><!-- End Search Bar -->
          ...
          <div class="row">
            ...
            <div class="add-ad">
              <div class="card-body text-center">
                <h5 class="card-title">Select Your Pricing Plan</h5>
                <p>Select Plan from Our plans to Ads</p>
              </div>
            </div>
            ...
            <div class="container">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-4 mt-4 text-center">
                  <div class="card-ad">
                  <div class="single_price_plan active wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                    ...
                    <div class="title">
                      <h3>1 WEEK</h3>
                      <p>Show Your place In Our home page
                        to reach more and more customers
                      </p>
                      <div class="line mb-3 justify-content-center"></div>
                    </div>
                    <div class="price">
                      <h4>$9.99</h4>
                    </div>
                    <div class="description">
                      <p><i class="bi bi-check-circle pe-2"></i>Duration: 7 Days</p>
                    </div>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-4 mt-4 text-center">
                  ...
                  <div class="single_price_plan active wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                    ...
                    <div class="description">
                      <p><i class="bi bi-check-circle pe-2"></i>Duration: 30 Days</p>
                    </div>
                    <div class="button"><a class="btn btn-warning" href="#">Get Started</a></div>
                  </div>
                </div>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-4 mt-4 text-center">
                  ...
                  <div class="single_price_plan active wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                    ...
                    <div class="description">
                      <p><i class="bi bi-check-circle pe-2"></i>Duration: 60 Days</p>
                    </div>
                    <div class="button"><a class="btn btn-warning" href="#">Get Started</a></div>
                  </div>
                </div>

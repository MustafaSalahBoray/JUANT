        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="branchesManagementRequests.php">Select Branch</a></li>
                            ...
                            <div class="card">
                                <div class="card-body pt-3">
                                    ...
                                    <div class="back-bar text-center mb-4">
                                        <a href="branchesManagementRequests.php"><i class="bi bi-arrow-left-circle-fill"></i>                   
                                        </a>
                                    </div><!-- End Search Bar -->
                                                        ...
                                                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                        ...
                                                                        <div class="card info-card sales-card">                                             
                                                                            <div class="news">
                                                                                <div class="post-item">
                                                                                    ...
                                                                                    <p class="info mt-3 mb-2"><a href="#">See request Information <i class="bi bi-caret-right-fill"></i></a></p>
                                                                                    <div class="ms-3">
                                                                    ...
                                                                    <!-- End place Card -->
                                                                    <!-- place Card -->
                                                                    <div class="col-xxl4 col-md-4 my-2">
                                                                        <div class="card info-card sales-card">                                             
                                                                            <div class="news">
                                                                                <div class="post-item">
                                                                                    <img src="assets/img/A5C9D517-C24E-42BA-9793-914488CDDC05.jpeg" alt="">

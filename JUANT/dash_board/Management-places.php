    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Place Details</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card">
                <div class="card-body pt-3">
                  ...
                  <div class="back-bar text-center">
                    <a href="Places.php"><i class="bi bi-arrow-left-circle-fill"></i>             </a>
                  </div><!-- End Search Bar -->
                  ...
                  <div class="card-body pt-3">
                    ...
                    <ul class="nav nav-tabs nav-tabs-bordered">
                      ...
                      <li class="nav-item">
                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview">SomeWhere Details</button>
                      </li>
                      ...
                      <div class="tab-pane fade show active profile-overview" id="profile-overview">      
                        ...
                        <div class="card-profile text-center">
                          <div class="card-body profile-card d-flex flex-column align-items-center">
                            <h5 class="card-title mb-3 text-center">Images</h5>

                            <div class="container-fluid">
                              <div class="scrolling-wrapper row flex-row flex-nowrap text-center">
                                 <?php 
                                     require '../signUpPage/dp.php';
                                         if (isset($_GET['Details'])) {
                                           $select=$db->prepare("SELECT * FROM  image WHERE place_img =:id");
                                           $select->bindparam("id",$_GET['Details']);
                                           if ( $select->execute()) {
                                        
                                           
                                           $select=$select->fetchAll(PDO::FETCH_ASSOC);
                                           foreach ($select as $key ) {
                                          echo ' <img src="../img_place/'.$key['image']. '" alt="">' ;
                                        }
                                           }
                                           else{
                                            echo "string";
                        ...
                        <div class="justify-content-center">
                          <div class="row">
                               <?php 
                                  ...
                                  ?>
                            <div class="col-lg-12 col-md-4 label "><i class="bi bi-file-text"></i>About: <span><?php echo $key['about']?></span></div>
                          </div>
  
        
                          <div class="row">
                            <div class="col-lg-12 col-md-4 label "><i class="bi bi-geo-alt"></i>Location: <a class="location" href="https://www.google.com/maps/place/ZED+TENNIS+ACADEMIES/@30.0432287,30.9944292,15z/data=!4m6!3m5!1s0x14585ba0263118cf:0xc58e189c21cc4eeb!8m2!3d30.0432287!4d30.9944292!16s%2Fg%2F11j4vlx59q?coh=164777&entry=tt"><span><?php echo $key['Governorate']?></span></a> </div>
                          </div>
        
                          <div class="row">
                            <div class="col-lg-12 col-md-4 label "><i class="bi bi-cash"></i>Min-Budget: <span>$<?php echo $key['minBudget']?></span></div>
                          </div>
        

                          <div class="row">
                            <div class="col-lg-12 col-md-4 label "><i class="bi bi-person-bounding-box"></i>Capacity: <span><?php echo $key['capacity']?></span></div>
                          </div>

                          <div class="row">
                            <div class="col-lg-12 col-md-4 label "><i class="bi bi-credit-card"></i>Payment Way:<?php echo $key['types']?> <span></span></div>
                          </div>

                          <div class="row">
                            <div class="col-lg-12 col-md-4 label "><i class="bi bi-star"></i>Rate: <span><?php echo $key['Rating']?></span></div>
                          </div>

                          <div class="row">
                            <div class="col-lg-12 col-md-4 label "><i class="bi bi-phone"></i>Phone: <span><?php echo $key['phone']?></span></div>
                          </div>
        
                          <div class="row">
                            <div class="col-lg-12 col-md-4 label "><i class="bi bi-envelope"></i>Email: <span><?php echo $key['email']?></span></div>
                          </div>

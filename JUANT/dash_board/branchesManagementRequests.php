...
<head>
  ...
  <title>Manage bransches requests - JuantHost</title>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Select Branch</li>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-3">
                <div class="card-body pt-3">
                  ...
                  <div class="search-bar">
                    <form class="search-form d-flex align-items-center" method="POST" action="#">
                      <input type="text" name="query" placeholder="Search By Location" title="Enter search keyword" id="search-input">
                  ...
                  <div class="filter">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                      ...
                      <li><a class="dropdown-item" href="#">High Requests</a></li>
                      <li><a class="dropdown-item" href="#">Low Requests</a></li>
                    </ul>
                  </div>
          ...
          <div class="row">
            ...
            <div class="add-places">
              <div class="card-body text-center">
                <h5 class="card-title">Choose Branch for Management</h5>
                <p>Pick the branch that you want Management their requstests and get business start</p>
                ...
                <div class="card info-card sales-card">
                  ...
                  <div class="card-body my-4 pb-1 text-center align-items-center">
                    ...
                    <div class="d-flex justify-content-center pt-4">
                        <div class="pb-2">
                          <span class="small pt-1 fw-bold bi bi-geo-alt"></span> <span class="text-muted small pt-1 ps-1">Giza, Zamalek</span> 
                        </div>
                    </div>

                    <div class="d-flex justify-content-center">
                        <div class="pb-2">
                          <span class="small pt-1 fw-bold bi bi-ticket"></span> <span class="text-muted small pt-1 ps-1">Requests:142</span> 
                        </div>
                    </div>

                    <div class="d-flex justify-content-center pt-3">
                        <div class="">
                          <a href="managementBooking.php" class="button2 btn-primary btn-lg" title="">MANAGE</a>
                        </div>
                      </div>
                  </div>

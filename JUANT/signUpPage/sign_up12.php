        ...
        <div class="mx-auto">
                            ...
                            <div class="col-md-8 col-10 my-auto">
                                ...
                                <form id="form" method="POST">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="Company" id="lastName" placeholder="CompanyName" class="form-control" />
                                    ...
                                    <div class="form-group2">
                                      ...
                                      <div class="form-group">
                                        <select class="form-control" id="sel1" name="SELCT">
                                          <option>Park</option>
            ...
            require 'dp.php';
                if (isset($_POST['submit'])) {  
                     ...
                     $reqister=$db->prepare("INSERT INTO owner (Fullname,CompanyName,type,Email,Phone,password,Cpassword) VALUES (:Fullname,:CompanyName,:type,:Email,:Phone,:password,:Cpassword)");
        $reqister->bindparam("Fullname",$_POST['firstName']);
          $reqister->bindparam("CompanyName",$_POST['Company']);
         $reqister->bindparam("type",$_POST['SELCT']);
         $reqister->bindparam("Email",$_POST['email']);
            $reqister->bindparam("Phone", $_POST['Phone']);
          $reqister->bindparam("password",$_POST['password']);
          $reqister->bindparam("Cpassword",$_POST['cPassword']);
             if ($reqister->execute()) {

                    echo "<script> window.open('http://localhost/JUANT/JUANT/dash_board/index.php','_self')</script>";
             }
             else{
              echo"ss";
             }
